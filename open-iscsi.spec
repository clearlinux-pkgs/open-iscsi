...
Source0  : https://github.com/open-iscsi/open-iscsi/archive/2.1.2/open-iscsi-2.1.2.tar.gz
...
%prep
%setup -q -n open-iscsi-2.1.2
cd %{_builddir}/open-iscsi-2.1.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595882131
...
cp %{_builddir}/open-iscsi-2.1.2/COPYING %{buildroot}/usr/share/package-licenses/open-iscsi/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
