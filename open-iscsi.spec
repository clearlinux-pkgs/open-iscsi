...
Version  : 2.1.8
Release  : 43
URL      : https://github.com/open-iscsi/open-iscsi/archive/2.1.8/open-iscsi-2.1.8.tar.gz
Source0  : https://github.com/open-iscsi/open-iscsi/archive/2.1.8/open-iscsi-2.1.8.tar.gz
...
%prep
%setup -q -n open-iscsi-2.1.8
cd %{_builddir}/open-iscsi-2.1.8
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664230820
export GCC_IGNORE_WERROR=1
export CFLAGS="$CFLAGS -fno-lto "
export FCFLAGS="$FFLAGS -fno-lto "
export FFLAGS="$FFLAGS -fno-lto "
export CXXFLAGS="$CXXFLAGS -fno-lto "
make  %{?_smp_mflags}  sbindir=/usr/bin
...
cp %{_builddir}/open-iscsi-%{version}/COPYING %{buildroot}/usr/share/package-licenses/open-iscsi/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install sbindir=/usr/bin install_systemd
